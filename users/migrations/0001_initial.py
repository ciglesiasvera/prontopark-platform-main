    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('supervisor', 'Supervisor'), ('admin', 'Administrator'), ('concierge', 'Concierge'), ('parking_owner', 'Parking Owner'), ('resident', 'Resident'), ('visit', 'Visit')], default='visit', max_length=50)),
